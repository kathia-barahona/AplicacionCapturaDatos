...
class RegistrosControllerTest < ActionController::TestCase
  ...
  test "should create registro" do
    assert_difference('Registro.count') do
      post :create, registro: { channel: @registro.channel, h_final: @registro.h_final, h_inicio: @registro.h_inicio, location: @registro.location, type: @registro.type, user_id: @registro.user_id }
    end
  ...
  test "should update registro" do
    patch :update, id: @registro, registro: { channel: @registro.channel, h_final: @registro.h_final, h_inicio: @registro.h_inicio, location: @registro.location, type: @registro.type, user_id: @registro.user_id }
    assert_redirected_to registro_path(assigns(:registro))
  end
